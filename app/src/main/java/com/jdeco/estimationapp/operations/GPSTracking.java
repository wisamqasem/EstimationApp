...
/**
 * Created by mmuneer on 03/29/2017.
 */
...
public class GPSTracking extends Service implements LocationListener {
    ...
    public void showSettingsAlert(){
        ...
        alertDialog.setMessage(mContext.getString(R.string.not_enable_gps_dialog_msg));
        ...
        alertDialog.setNegativeButton(mContext.getString(R.string.cancel_lbl), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
            }
        });
